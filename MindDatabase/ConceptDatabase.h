...
namespace Mind
{
	...
	class _MINDDATABASEINOUT ConceptDatabase : public MindDatabase
	{
		...
		friend class AnalyzeChineseDictionary;
	public:
	...
	private:
		...
		bool GetNonBaseConceptRow(const int id, const string word, CommonTool::DBRow& row);
		...
		//Delete rows in Connection table.
		void DeleteConnectionTable();

		//Clear connection field of Non base concepts.
		void ClearConnectionOfNonBaseConcept();
	};
