...
TEST_F(Test_iRelation, Test_RelationSingleNode_GenerateSingleConcept)
{
	...
	//When satisfying, the symbol in <singleNode> maps to "五".
	//Then make the other RelationSingleNode map correspondingly
	//and the special relation generated by <singleNode2> becomes "五".
	...
	shared_ptr<MockExpression> expre = MockExpression::Create_SingleConcept("五");
