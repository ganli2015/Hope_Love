...
namespace Mind
{
	...
	public:
		...
		virtual vector<shared_ptr<iConcept>> GetAllBaseConcepts() const = 0;

		virtual vector<shared_ptr<iConcept>> GetAllConcepts() const = 0;

		//Get all concepts with word<str>.
		virtual vector<shared_ptr<iConcept>> GetConcepts(const string str) const = 0;
		...
		//The input chain should constitute of base concepts and the returned chain constitutes of base concepts as well.
